  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="../studentlogin/projStatus.php">Project Status</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="#">Guide Login</a>
        </li>
        <li class="nav-item">
    ...
    <div class="center"style="box-shadow: 2px 4px 8px #2691d9;">
      ...
      <form method="post">
        ...
        <div class="pass"><a href="forgotpwdguide.php" style="text-decoration:none;">Forgot password?</a></div>
        <input type="submit" style="backgroundcolor: #2691d9;" value="Login">
        <br/>
        <br/>
        <div class="sigunup_link">
          Not a member?<a href="signup_guide.php" style="text-decoration:none;">Signup</a>
        </div>
        <br/>
      </form>
    </div>
